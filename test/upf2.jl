@testset "[UPF v2.0.1] Internal data consistency" begin
        ...
        if psp.header.is_ultrasoft | psp.header.is_paw
            ...
            if augmentation.q_with_l
                ...
                @test length(augmentation.qijs) ==
                      psp.header.number_of_proj * (psp.header.number_of_proj + 1) / 2
            end
...
@testset "[UPF v2.0.1] he-q2.upf" begin
    ...
    @test header.comment == "Contains atomic orbitals generated by ld1.x - use with care"
